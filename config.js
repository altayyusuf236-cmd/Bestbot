module.exports = {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1487568096125259878", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
  ...
  DASHBOARD: {
    ...
    baseURL: "https://bestbot-3khp.onrender.com", // base url
    failureURL: "https://bestbot-3khp.onrender.com", // failure redirect url
  ...
  STATS: {
    ...
    DEFAULT_LVL_UP_MSG: "{member:tag}, **{level}** Leveline yükseldin.",
  },
